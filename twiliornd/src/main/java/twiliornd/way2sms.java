...
public class way2sms {
    ...
    {  
        final String USERNAME="9867034300";//REQUIRED
        final String PASSWORD="Newuser@123";//REQUIRED
        final String ACTION="405AA82A096E5A9FDC24BEFB49FA79DF";//REQUIRED : In order to understand ACTION value please read the blog
